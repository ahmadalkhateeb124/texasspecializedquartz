<?php
// employee/includes/head.php — same unified theme as the customer portal (saddle + black + white)
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'Employee Portal') ?> — Texas Specialized Quartz &amp; Granite</title>
