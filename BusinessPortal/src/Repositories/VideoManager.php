...
class VideoManager
{
    ...
    public function __construct($pdo)
    {
        ...
        // Absolute path to BusinessPortal/auth/uploads/videos/ — avoids DOCUMENT_ROOT pitfalls
        $this->uploadsDir = realpath(__DIR__ . '/../..') . '/auth/uploads/videos/';
    ...
    {
        return bp_url('/auth/uploads/videos/' . $filename);
    }
