...
/**
 * admin/order-view.php — Fabrication Order Detail
 */
...
try {
    $stmt = $pdo->prepare("SELECT f.* FROM fabrication_orders f WHERE f.id = ?");
    $stmt->execute([$id]);
        ...
        <main class="page-content fade-up">
            ...
            <div class="page-header">
                ...
                <div class="page-actions">
                    ...
                    <a href="../OrderEdit.php?id=<?= $order['id'] ?>" class="btn btn-primary">
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h6 class="card-title"><i class='bx bx-user text-primary'></i> Customer</h6>
                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h6 class="card-title"><i class='bx bx-briefcase text-primary'></i> Sales Rep</h6>
                        </div>
                        <div class="card-section">
                            <dl style="margin:0;display:grid;gap:10px;">
                                <div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title"><i class='bx bx-note text-primary'></i> Notes</h6>
                        </div>
                        <div class="card-section">
                            <p style="white-space:pre-wrap;margin:0;font-size:13px;color:var(--color-text);">
                                <?= !empty($order['notes']) ? htmlspecialchars($order['notes']) : '<span style="color:var(--color-text-sub)">No notes provided.</span>' ?>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <?php foreach ($job_sections as $idx => $job): ?>
                            <div class="card mb-3">
                                <div class="card-header">
                                    ...
                                    <span class="badge badge-neutral">ID <?= $job['id'] ?></span>
                                </div>
                                <div class="card-section">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div>
                                                <?php if (isset($job['tear_out'])): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge badge-neutrall">No</span>
                                                    <?php endif; ?>
                                                <?php else: echo '—';
                                                endif; ?>
                                            </div>
