...
/**
 * admin/calendar.php — Master calendar of all job schedule events.
 */
        ...
        <main class="page-content fade-up">
            ...
            <div class="page-header">
                <div class="page-header-left">
                    ...
                    <p class="page-subtitle"><?= count($events) ?> scheduled event<?= count($events) !== 1 ? 's' : '' ?></p>
                </div>
            </div>
        ...
        (function () {
            ...
            const cal = new FullCalendar.Calendar(el, {
                ...
                eventClick: (info) => {
                    ...
                    document.getElementById('evOpenOrder').href = 'order-view.php?id=' + p.order_id;
