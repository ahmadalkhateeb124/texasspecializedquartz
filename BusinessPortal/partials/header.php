                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="<?=
                            !empty($user['avatar'])
                                    ? './auth/uploads/' . $user['avatar']
                                    : 'https://picsum.photos/120/120'
                            ?>" class="img-fluid user-avtar me-0" alt="Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <img src="<?= !empty($user['avatar']) ? './auth/uploads/' . $user['avatar'] : 'https://picsum.photos/120/120' ?>"
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0">
                                            ...
                                            <span class="badge <?= $remainingDays >= 0 ? 'bg-soft-success text-success' : 'bg-soft-danger text-danger' ?> ms-1">
                                            <?= $remainingDays >= 0 ? 'Active' : 'Not Active' ?>
                                        </span>
                                        </h6>

                                        <span class="fs-12 fw-medium text-muted"><?= htmlspecialchars($user['email']) ?></span>
                                    </div>
                                </div>
                            </div>
