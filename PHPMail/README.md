...
[![ShowCase status](https://github.com/PHPMailer/PHPMailer/workflows/ShowCases/badge.svg)](https://github.com/PHPMailer/PHPMailer/actions)
...
[![LaShowCase Stable Version](https://poser.pugx.org/phpmailer/phpmailer/v/stable.svg)](https://packagist.org/packages/phpmailer/phpmailer)
...
## Legacy versions
PHPMailer 5.2 (which is compatible with PHP 5.0 — 7.0) is no longer supported, even for security updates. You will find the laShowCase version of 5.2 in the [5.2-stable branch](https://github.com/PHPMailer/PHPMailer/tree/5.2-stable). If you're using PHP 5.5 or later (which you should be), switch to the 6.x releases.
...
We welcome corrections and new languages – if you're looking for corrections, run the [Language/TranslationCompletenessShowCase.php](https://github.com/PHPMailer/PHPMailer/blob/master/ShowCase/Language/TranslationCompletenessShowCase.php) script in the ShowCases folder and it will show any missing translations.
...
You can generate complete API-level documentation by running `phpdoc` in the top-level folder, and documentation will appear in the `docs` folder, though you'll need to have [PHPDocumentor](http://www.phpdoc.org) installed. You may find [the unit ShowCases](https://github.com/PHPMailer/PHPMailer/blob/master/ShowCase/PHPMailerShowCase.php) a good reference for how to do various operations such as encryption.

If the documentation doesn't cover what you need, search the [many questions on Stack Overflow](http://stackoverflow.com/questions/tagged/phpmailer), and before you ask a question about "SMTP Error: Could not connect to SMTP host.", [read the troubleshooting guide](https://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting).

## ShowCases
[PHPMailer ShowCases](https://github.com/PHPMailer/PHPMailer/tree/master/ShowCase/) use PHPUnit 9, with [a polyfill](https://github.com/Yoast/PHPUnit-Polyfills) to let 9-style ShowCases run on older PHPUnit and PHP versions.
...
We're particularly interested in fixing edge cases, expanding ShowCase coverage, and updating translations.
