...
class PHPMailer
{
     ...
     *
     * @see http://www.andrew.cmu.edu/user/agreen1/ShowCaseing/mrbs/web/Mail/RFC822.php A more careful implementation
     *
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                 ...
                 *  * quoted elements: `'"ShowCase blah"@example.org'`
     ...
     * Picks shorShowCase of Q, B, or none. Result includes folding if needed.
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        //Select the encoding that produces the shorShowCase output and/or prevents corruption.
